...
public partial class JavaBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IJavaVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="JavaParser.type"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitType([NotNull] JavaParser.TypeContext context) { return VisitChildren(context); }
